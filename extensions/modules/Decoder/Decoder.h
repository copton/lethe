...
#ifndef __EXTENSIONS__MODULES__DECODER_H
#define __EXTENSIONS__MODULES__DECODER_H
...
namespace Extensions {
    namespace Modules {
        namespace Decoder {
            ...
            private:
                typedef Lethe::Adapter<InputStream1, OutputStream1> Ports;
                Ports ports;
                
                typedef typename Ports::InputVector InputVector;
            ...
            protected:
                ...
                Decision user_trigger(Lethe::Caller caller)
                {
                    ...
                    InputVector in = ports.input(1);
                    OutputVector out = ports.output(2);

                    out[0].value = static_cast<int>(in[0].real);
                    out[1].value = static_cast<int>(in[0].img);
