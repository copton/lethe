...
{
stream0 = new Stream0(0, 2, 2, 1);
stream1 = new Stream1(1, 1, 1, 1);
stream2 = new Stream2(2, 1, 1, 1);
stream3 = new Stream3(3, 2, 1, 1);

module0 = new Module0(0, "Quelle", 0, 1, controller, isVector[0]);
module1 = new Module1(1, "Kodierer", 1, 1, controller, isVector[1]);
module2 = new Module2(2, "Kanal", 1, 1, controller, isVector[2]);
module3 = new Module3(3, "Dekodierer", 1, 1, controller, isVector[3]);
module4 = new Module4(4, "Senke", 2, 0, controller, isVector[4]);

module0->addOutputStream(stream0, 0, 0);
stream0->addWriter(module0, 0, 0);
module1->addInputStream(stream0, 0, 0);
stream0->addReader(module1, 0, 0);
module1->addOutputStream(stream1, 0, 0);
stream1->addWriter(module1, 0, 0);
module2->addInputStream(stream1, 0, 0);
stream1->addReader(module2, 0, 0);
module2->addOutputStream(stream2, 0, 0);
stream2->addWriter(module2, 0, 0);
module3->addInputStream(stream2, 0, 0);
stream2->addReader(module3, 0, 0);
module3->addOutputStream(stream3, 0, 0);
stream3->addWriter(module3, 0, 0);
module4->addInputStream(stream0, 0, 1);
stream0->addReader(module4, 0, 1);
module4->addInputStream(stream3, 1, 0);
stream3->addReader(module4, 1, 0);
...
private:
typedef Core::Templates::Stream<Extensions::Types::Integer, Extensions::Types::Integer> Stream0;
...
typedef Extensions::Modules::Encoder::Module<Stream0,Stream1> Module1;
typedef Extensions::Modules::Channel::Module<Stream1,Stream2> Module2;
typedef Extensions::Modules::Decoder::Module<Stream2,Stream3> Module3;
typedef Extensions::Modules::Sink::Module<Stream0,Stream3> Module4;
